...
class QuizSummaryPage extends StatelessWidget {
  ...
  String _formatUserAnswer(Question question) {
    ...
    if (question.selectedAnswers is List) {
      return (question.selectedAnswers as List).join(", ");
    }
    else if (question.selectedAnswers is Map) {
    ...
    else if (question.selectedAnswers is String) {
      return question.selectedAnswers as String;
    }
